...
CREATE TABLE blogs(id serial PRIMARY KEY, namedomain VARCHAR(24) NOT NULL , title VARCHAR(50) NOT NULL, id_user INT);
CREATE TABLE messages(id serial PRIMARY KEY , title varchar(30), category varchar(10) NOT NULL , hashtags varchar(550),
                      date TIMESTAMP NOT NULL , likes INT, content VARCHAR(5000) NOT NULL, id_blog INT);
